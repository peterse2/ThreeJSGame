class Dagger {
    constructor(){
        ...
        const hiltTex = new THREE.ImageUtils.loadTexture("Images/hilt.jpg");
        const hiltMat = new THREE.MeshPhongMaterial({ map: hiltTex});
        const steelTex = new THREE.ImageUtils.loadTexture("Images/steel2.jpg");
        const steelMat = new THREE.MeshPhongMaterial({ map: steelTex});
        const goldTex = new THREE.ImageUtils.loadTexture("Images/gold.jpg");
